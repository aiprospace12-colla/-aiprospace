...
export const RESOURCES: Resource[] = [
  {
    ...
    type: 'Cheat Sheet',
    url: '/api/download/ai-tools-cheat-sheet',
  },
  {
    ...
    type: 'Template',
    url: '/api/download/n8n-templates-pack',
  },
  {
    id: '100-ai-prompts',
    ...
    type: 'Prompt Library',
    url: '/api/download/100-ai-prompts',
  },
  {
    ...
    type: 'eBook',
    url: '/api/download/beginners-guide-to-ai',
  },
  {
    id: 'ai-seo-checklist',
    ...
    type: 'Checklist',
    url: '/api/download/ai-seo-checklist',
  },
  {
    ...
    type: 'eBook',
    url: '/api/download/make-money-ai-toolkit',
  },
]
